...
public class LinkedHashMapCustomApp {
	 ...
	 * Output
	 *
	 * Display values corresponding to keys> value corresponding to key 21=12 value
	 * corresponding to key 51=null Displaying : {21=12} {25=121} {30=151} {33=15}
	 * {35=89}
	 *
	 * value corresponding to key 21 removed: true value corresponding to key 22
	 * removed: false Displaying : {25=121} {30=151} {33=15} {35=89}
	 *
	 */
...
/**
 *
 * This class provides custom implementation of LinkedHashMap(without using java
 * api's)- which allows us to store data in key-value pair form. It maintains
 * insertion order, uses DoublyLinkedList for doing so. If key which already
 * exists is added again, its value is overridden but insertion order does not
 * change, BUT, if key-value pair is removed and value is again added than
 * insertion order changes(which is quite natural behavior).
 *
 * @param <K>
 * @param <V>
 */
